...
class _RandomNamesState extends State<RandomNames> {
  final _nameSuggestions = <WordPair>[];
  ...
  Widget _buildSuggestions() {
     return ListView.builder(
         ...
         itemBuilder: (context,i){
           ...
           final index = i ~/ 2;
           if (index >= _nameSuggestions.length) {
             _nameSuggestions.addAll(generateWordPairs().take(10));
           }
           return _buildRow(_nameSuggestions[index]);
         } );
  }
